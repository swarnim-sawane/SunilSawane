...
export interface ApiArtworkArtwork extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    framingStatus: Schema.Attribute.Enumeration<
      ['unframed', 'framed', 'framing_available', 'to_be_confirmed']
    > &
    ...
    publishedAt: Schema.Attribute.DateTime;
    shippingNote: Schema.Attribute.Text;
    slug: Schema.Attribute.UID<'title'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yearCreated: Schema.Attribute.Integer;
  };
}
